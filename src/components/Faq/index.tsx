  ...
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap justify-center lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What do I get for my ₹99 investment?"
              answer="You’ll receive exclusive access to a complete financial growth toolkit, including curated podcasts, YouTube videos, and books on saving, earning, and managing money."
            />
            <SingleFaq
              question="Is this a one-time payment or a subscription?"
              answer="It’s a one-time payment of $99. No recurring fees!"
            />
            <SingleFaq
              question=" How will I receive the resources?"
              answer="After your purchase, you'll get immediate access to all resources via a secure download link."
            />
               <SingleFaq
              question="Can I access the resources on multiple devices?"
              answer="Absolutely! You can access the toolkit on any device – desktop, tablet, or mobile."
            />
          </div>
