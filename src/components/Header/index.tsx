          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <Link
                          href="/register"
                          className="rounded-lg ml-2 bg-primary px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-primary/90 dark:bg-white/10 dark:hover:bg-white/20"
                        >
                          Get Started Now
                        </Link>
